...
export const CustomerServiceHistory: React.FC = () => {
    ...
    const groupHistory = (items: ServiceHistoryItem[]) => {
        ...
        items.forEach(item => {
            ...
            if (year === currentYear && month === currentMonth) label = "This Month";
            else if (year === currentYear && month === currentMonth - 1 || (currentMonth === 0 && month === 11 && year === currentYear - 1)) label = "Last Month";
        ...
        <div className="container-fluid">
            ...
            <Card>
                <div className="d-flex align-items-center justify-content-between">
                    <div className="d-flex align-items-center">
                        <Avatar src={customer?.profile_image_url} size="lg" className="mr-4" />
                        <div>
            ...
            <div className="row" style={{ minHeight: 'calc(100vh - 450px)' }}>
                <div className="col-md-8 d-flex mb-4">
                    <Card className="timeline flex-fill" bodyClassName="overflow-auto">
                        {Object.keys(groupedHistory).length === 0 ? (
                            <EmptyState icon="fe-clock" title="No Service History" description="When an appointment is completed and invoiced, it will appear here." />
                        ) : (
                                                ...
                                                <div className="pl-5">
                                                    ...
                                                    {item.notes && (
                                                        <div className="card d-inline-flex mb-2">
                                                            <div className="card-body bg-light py-2 px-3 text-muted">{item.notes}</div>
                                                        </div>
                                                    )}
                                                </div>
                                            </div>
                ...
                <div className="col-md-4 d-flex mb-4">
                    <Card title="Additional Notes" className="flex-fill">
                        <div className="mb-4">
                        ...
                        <div className="custom-control custom-checkbox mt-2">
                            ...
                            <label className="custom-control-label" htmlFor="mediaConsentDisplay">Media consent {customer?.media_consent ? 'granted' : 'denied'}</label>
                        </div>
                    </Card>
                </div>
            </div>
